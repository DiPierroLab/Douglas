...
plot(d*bead_size_new, vec39,'-', label='IC/6   AA/2  first 20 beads have IC = 0')
plot(d*bead_size_new, vec45,'--', label='IC/6   AA/2  extrapolation first 20 beads')
plot(d*bead_size_new, vec48,'-.', label='IC/6   AA/2  extrapolation first 40 beads')
