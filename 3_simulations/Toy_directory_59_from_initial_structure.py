lambdas_file_name = "lambdas59"#you should have three .txt files in dense format in the lambdas folder; 
...
sim.saveFolder('./')
Struc = sim.loadNDB(NDBfiles=['/scratch/white.do/Pairing/directory_59/part_1/chr_chr_0_block'+str(n_blocks)+'.ndb','/scratch/white.do/Pairing/directory_59/part_1/chr_chr_1_block'+str(n_blocks)+'.ndb'])
