lambdas_file_name = "lambdas160"#you should have three .txt files in dense format in the lambdas folder; 
...
Ecut = 32.0 #parameter for the force which repels beads from each other when they get close
#========================================
import datetime
import sys
