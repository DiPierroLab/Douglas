...
typesPlist = ['AAAA','AAAA'] # list of sequence names to help reference the correct AB type sequence files
typesMlist = ['AAAA','AAAA']

i = 0 #keeps track of which sequence name to use
for directory_number in {80,81}: # Make directory numbers consistent with the sequence name lists above. Otherwise the output is faulty.
