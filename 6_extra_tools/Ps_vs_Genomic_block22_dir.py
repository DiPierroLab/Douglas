...
typesPlist = ['AAAA','AAAA','AAAA','AAAA','AAAA','AAAA'] # list of sequence names to help reference the correct AB type sequence files
typesMlist = ['AAAA','AAAA','AAAA','AAAA','AAAA','AAAA']

i = 0 #keeps track of which sequence name to use
for directory_number in {55,56,57,58,59,60}: # Make directory numbers consistent with the sequence name lists above. Otherwise the output is faulty.
