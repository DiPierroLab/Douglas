...
# edited by Ailun Wang to allow h5 to work with OpenMiChroM version 1.0.3
__date__   = "Set/2020"
...
Chrom_types     = ['ZA','OA','FB','SB','TB','LB','NA']#UN changed to NA
Chrom_types_NDB = ['A1','A2','B1','B2','B3','B4','NA']#UN changed to NA
...
Type_conversion = {'A1':'A1','A2':'A2','B1':'B1','B2':'B2','B3':'B3','B4':'B4','NA':'NA'}
...
type_list=[x.decode('utf-8') for x in list(cndbf['types'])]
...
try: 
    ...
    Wloop = False
print("========================================")
print("Make sure to choose correct first frame.")
print("========================================")
for mdl in range(1,totalModel,1):
    if mdl % 1000 == 0:
        print("writing frame %d" %mdl)
